...
const SONGS = [
  ...
  },
  {
    id: 'clair-de-lune',
    title: 'Clair de Lune',
    subtitle: 'Debussy masterpiece',
    bpm: 76,
    difficulty: 'hard',
    unlocks: ['interstellar'],
    steps: [
      { notes: ['E5'], beats: 1 }, { notes: ['F5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['F5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['D#5'], beats: 1 },
      { notes: ['D5'], beats: 1 }, { notes: ['C5'], beats: 1 },
      { notes: ['D5'], beats: 2 }, { notes: ['C5'], beats: 2 },
      { notes: ['B4'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['B4'], beats: 2 }, { notes: ['A4'], beats: 2 },
      { notes: ['G#4'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['B4'], beats: 2 }, { notes: ['C5'], beats: 2 },
    ],
    goalAccuracy: 92
  },
  {
    ...
    subtitle: 'Epic space journey',
    bpm: 84,
    difficulty: 'hard',
    unlocks: ['the-entertainer'],
    steps: [
      { notes: ['A4'], beats: 2 }, { notes: ['E5'], beats: 2 },
      { notes: ['D5'], beats: 2 }, { notes: ['C5'], beats: 2 },
      { notes: ['B4'], beats: 2 }, { notes: ['A4'], beats: 2 },
      { notes: ['B4'], beats: 1 }, { notes: ['C5'], beats: 1 },
      { notes: ['D5'], beats: 2 }, { notes: ['E5'], beats: 2 },
      { notes: ['A4'], beats: 2 }, { notes: ['E5'], beats: 2 },
      { notes: ['D5'], beats: 2 }, { notes: ['C5'], beats: 2 },
    ],
    goalAccuracy: 92
  },
  {
    ...
    subtitle: 'Ragtime classic',
    bpm: 132,
    difficulty: 'hard',
    unlocks: ['bohemian-rhapsody'],
    steps: [
      { notes: ['D5'], beats: 1 }, { notes: ['D#5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['C5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['C5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['C5'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['D5'], beats: 1 },
      { notes: ['D#5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['D5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['D5'], beats: 1 }, { notes: ['C5'], beats: 2 },
  ...
  },
  {
    ...
    subtitle: 'Queen\'s epic ballad',
    bpm: 90,
    difficulty: 'very hard',
    unlocks: ['someone-like-you'],
    steps: [
      { notes: ['B4'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['G4'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['F4'], beats: 2 }, { notes: ['G4'], beats: 2 },
      { notes: ['A4'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['D5'], beats: 1 },
      { notes: ['E5'], beats: 2 }, { notes: ['D5'], beats: 2 },
      { notes: ['C5'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['A4'], beats: 2 }, { notes: ['G4'], beats: 2 },
    ],
    goalAccuracy: 94
  },
  {
    ...
    steps: [
      ...
      { notes: ['E5'], beats: 1 }, { notes: ['C#5'], beats: 1 },
      { notes: ['A4'], beats: 2 }, { notes: ['G#4'], beats: 1 },
      { notes: ['A4'], beats: 1 }, { notes: ['C#5'], beats: 2 },
      { notes: ['E5'], beats: 1 }, { notes: ['F#5'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['C#5'], beats: 1 },
      { notes: ['A4'], beats: 2 }, { notes: ['B4'], beats: 2 },
    ],
    goalAccuracy: 92
  },
  {
    id: 'all-of-me',
    title: 'All of Me',
    subtitle: 'John Legend romance',
    bpm: 126,
    difficulty: 'hard',
    unlocks: ['thousand-years'],
    steps: [
      { notes: ['F4'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['F4'], beats: 1 }, { notes: ['G4'], beats: 1 },
      { notes: ['A4'], beats: 2 },
      { notes: ['G4'], beats: 1 }, { notes: ['A4'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['D5'], beats: 1 },
      { notes: ['E5'], beats: 2 }, { notes: ['D5'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['A4'], beats: 2 },
    ],
    goalAccuracy: 93
  },
  {
    ...
    subtitle: 'Christina Perri classic',
    bpm: 92,
    difficulty: 'hard',
    unlocks: ['comptine'],
    steps: [
      { notes: ['C5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['G5'], beats: 2 }, { notes: ['E5'], beats: 1 },
      { notes: ['D5'], beats: 1 }, { notes: ['C5'], beats: 2 },
      { notes: ['B4'], beats: 1 }, { notes: ['C5'], beats: 1 },
      { notes: ['D5'], beats: 2 }, { notes: ['E5'], beats: 2 },
      { notes: ['C5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['G5'], beats: 2 }, { notes: ['E5'], beats: 2 },
    ],
    goalAccuracy: 92
  },
  {
    ...
    subtitle: 'Amélie soundtrack gem',
    bpm: 108,
    difficulty: 'very hard',
    unlocks: ['experience'],
    steps: [
      { notes: ['E5'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['G#4'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['E5'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['G#4'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['D#5'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['F#4'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['D#5'], beats: 1 }, { notes: ['B4'], beats: 1 },
      { notes: ['F#4'], beats: 1 }, { notes: ['B4'], beats: 1 },
    ],
    goalAccuracy: 95
  },
  {
    id: 'experience',
    title: 'Experience',
    subtitle: 'Einaudi emotional journey',
    bpm: 100,
    difficulty: 'very hard',
    unlocks: [],
    steps: [
      { notes: ['A4'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['A5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['B4'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['B5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['C5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['C#5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['D5'], beats: 1 }, { notes: ['E5'], beats: 1 },
      { notes: ['A4'], beats: 2 }, { notes: ['E5'], beats: 2 },
    ],
    goalAccuracy: 95
